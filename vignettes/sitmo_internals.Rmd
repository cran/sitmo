...
Within this vignette, details on how to use [sitmo](http://www.sitmo.com/article/parallel-random-number-generator-in-c/)'s
...
`sitmo` is a Parallel Psuedo Random Number Generator (PPRNG) that was conceived
by Thijs van den Berg after reading 
Salmon, K., et al.'s "Parallel Random Numbers: As Easy as 1, 2, 3" in the
conference proceedings of the 2011 International Conference for
...
[RngStreams](http://statmath.wu.ac.at/software/RngStreams/doc/rngstreams.html),
[OMPRNG](http://homepage.stat.uiowa.edu/~mbognar/omprng/). However, none are as
appealing in my eyes than [sitmo](http://www.sitmo.com/article/parallel-random-number-generator-in-c/), 
...
The `sitmo` header file is contained within this package.
To use the `sitmo` header within your own package, you can link to this 
